...
expand_match(Temp, Node, Cond) ->
    ...
    NewVar0=list_to_atom("_Res"++integer_to_list(rand:uniform(1000))),
    NewVar1=list_to_atom("_Bind"++integer_to_list(rand:uniform(1000))++"_@_V"),
    NewVar2=list_to_atom("_Bind"++integer_to_list(rand:uniform(1000))),
