...
%%--------------------------------------------------------------------
transform(_Args)-> 
    refac_funApp:transform_funApp(_Args, fun refac_funApp_arit_case:rules/2).
...
rules(FunArgs, FunDefInfo) ->
     refac_funApp:rules(FunArgs,FunDefInfo) ++ core_arithmetics:rules([], FunDefInfo) ++ core_case:rules(FunArgs, FunDefInfo).
