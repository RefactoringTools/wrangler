...
%%
%% $Id: refac_prettypr.erl,v 1.2 2008-04-30 11:12:20 go30 Exp $
%%
...
lay_2(Node, Ctxt) ->
	...
	binary_field ->
	    ...
	    D1= case erl_syntax:type(erl_syntax:binary_field_body(Node)) of 
		    application-> beside(floating(text("(")), beside(D, floating(text(")"))));  
		    _ -> D
		end,
